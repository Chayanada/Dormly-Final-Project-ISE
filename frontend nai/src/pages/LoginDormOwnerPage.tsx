...
export default function LoginDormOwnerPage() {
    ...
    return (
        ...
        <div className="flex-1 flex items-center justify-center px-4">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-center mb-8">Login Dorm Account</h1>
            ...
            <p className="text-center mt-6 text-sm">
                ...
                <button
                onClick={() => navigate('/register-dormowner')}
