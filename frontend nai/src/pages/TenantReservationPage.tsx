...
const mockRequests: DormRequest[] = [
    {
        id: '1',
        tenantName: 'สมศรี มณีแดง',
        tenantImage: 'https://via.placeholder.com/64/7F9CF5/FFFFFF?text=ส',
        roomType: 'พัดลม/เดี่ยว',
        checkInDate: '2025/12/01',
        numberOfMonths: 6,
        totalPrice: 16200,
        dormName: 'หอพัก A (พหลโยธิน 6)',
        status: 'อนุมัติแล้ว',
    },
    {
        id: '2',
        ...
        roomType: 'แอร์/เตียงคู่',
        checkInDate: '2025/12/15',
        numberOfMonths: 3,
        totalPrice: 12000,
        dormName: 'หอพัก B (ใกล้ ม.ดัง)',
        status: 'รอการอนุมัติ',
    },
    {
        id: '3',
        tenantName: 'วาสนา มีสุข',
        tenantImage: 'https://via.placeholder.com/64/27AE60/FFFFFF?text=ว',
        roomType: 'แอร์/เดี่ยว',
        checkInDate: '2025/11/20',
        numberOfMonths: 12,
        totalPrice: 48000,
        dormName: 'หอพัก C (หญิงล้วน)',
        status: 'รอการอนุมัติ',
    },
    {
        id: '4',
        tenantName: 'มานะ อารมณ์ดี',
        tenantImage: 'https://via.placeholder.com/64/8E44AD/FFFFFF?text=ม',
        roomType: 'พัดลม/เตียงคู่',
        checkInDate: '2025/10/25',
        numberOfMonths: 1,
        totalPrice: 3000,
        dormName: 'หอพัก D (วิวดี)',
        status: 'ปฏิเสธ',
    },
];
