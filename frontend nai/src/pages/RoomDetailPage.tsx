                    ...
                    <div className="bg-purple-50 rounded-xl p-6 shadow-sm border border-purple-200">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between py-2">
                                ...
                                <span className="font-bold">{room.pricePerMonth.toLocaleString()} บาท/เดือน</span>
                            </div>
                            <div className="flex justify-between py-2">
                            ...
                            <div className="flex justify-between py-2">
                                <span className="text-gray-700">จำนวงหน้า:</span>
                            ...
                            <div className="flex justify-between py-2 border-t border-purple-200 pt-3">
                                <span className="text-gray-700 font-medium">ค่าบริการอื่นๆ:</span>
                                <span className="font-bold">{room.commonFee} บาท/เดือน</span>
                            </div>
                        </div>
                    </div>
