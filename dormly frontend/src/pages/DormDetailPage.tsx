            ...
            try {
                const mockData: DormDetail = {
                    ...
                    images: [
                        ...
                        'https://images.unsplash.com/photo-1507652313519-d4e9174996dd?auto=format&fit=crop&w=500&q=80',
                    ],
                    description: 'Modern dormitory located in the heart of Bangkok, just minutes away from major universities. Perfect for students seeking convenient access to campus and city amenities. Features spacious rooms with contemporary furnishings and high-speed internet connectivity.',
                    facilities: ['WiFi', 'Air Conditioning', 'Parking', 'Security Camera', 'Laundry Service', 'Elevator', 'Key Card Access', 'Refrigerator', 'Water Heater'],
                    totalRooms: 50,
                    availableRooms: 12,
                    owner: {
                        name: 'Mr. Amorn Chaiyakul',
                        phone: '02-123-4567',
                        email: 'amorn@email.com',
                        lineId: '@central_dorm',
                        rating: 4.5,
                        reviewCount: 285,
                    ...
                    rooms: [
                        ...
                        },
                        {
                            ...
                            price: 2900,
                            status: 'available',
                            imageUrl: 'https://images.unsplash.com/photo-1616046229478-9901c5536a45?auto=format&fit=crop&w=500&q=80'
                        }
                    ]
                };
